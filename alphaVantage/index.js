...
let credentials = {
    "web": {
        "client_id": "461420881554-vohtumtl57fgfk63ft022vb2mqa4ufkl.apps.googleusercontent.com",
...
$(document).ready(function () {
    ...
    $(".googleIcon").on("click", function () {//LOG IO OR UPLOAD ON DRIVE
        ...
        if (localStorage.getItem("accessToken") === null) {
            ...
            upload_.done(function (data) {
                $("#uploadResult")
                    .removeClass("alert-danger").removeClass("alert-warning")
    ...
    function signIn(clientId, clientSecret, redirectUri, scope) {
        let url = "https://accounts.google.com/o/oauth2/v2/auth?redirect_uri=" + redirectUri
    ...
    setTimeout(function () { $(".loader").slideUp(); $(".loader .lds-ring").fadeOut(); }, 1500);
